export default function MainPage() {
  return (
    <div className="w-full flex flex-col gap-2 p-2 border-x border-foreground">
      <h2 className="text-4xl p-2 font-bold rounded-md bg-accent text-warm-white">
        Главная страница
      </h2>
      <section className="flex flex-col gap-1 p-2 bg-dimmedblue rounded-md text-warm-white">
      ...
      <section className="p-2 bg-dimmedblue rounded-md text-warm-white">
